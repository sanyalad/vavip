...
const demoCards = [
  { title: '╨г╨╖╨╡╨╗ ╨▓╨▓╨╛╨┤╨░ V01', price: '9 ╤В.╤А.', href: '/shop/product/v01-meter', tag: '╨Э╨╛╨▓╨╕╨╜╨║╨░' },
  { title: '╨г╨╖╨╡╨╗ ╨▓╨▓╨╛╨┤╨░ V02', price: '10 ╤В.╤А.', href: '/shop/product/v02-clean', tag: '╨Э╨╛╨▓╨╕╨╜╨║╨░' },
  { title: '╨г╨╖╨╡╨╗ ╨▓╨▓╨╛╨┤╨░ V03', price: '15 ╤В.╤А.', href: '/shop/product/v03-cold', tag: '╨Э╨╛╨▓╨╕╨╜╨║╨░' },
  { title: '╨г╨╖╨╡╨╗ ╨▓╨▓╨╛╨┤╨░ V04', price: '12 ╤В.╤А.', href: '/shop/product/v04-dual', tag: '╨Э╨╛╨▓╨╕╨╜╨║╨░' },
]
            ...
            <div className={styles.body}>
              <aside className={styles.left}>
                <div className={styles.block}>
                  <div className={styles.blockTitle}>╨Ъ╨Р╨в╨Х╨У╨Ю╨а╨Ш╨Ш</div>
              ...
              <div className={styles.right} aria-label="╨а╨╡╨╖╤Г╨╗╤М╤В╨░╤В╤Л">
