        ...
        <>
          ...
          >
            <div className={styles.header}>
              <h2 className={styles.title}>╨Ъ╨╛╤А╨╖╨╕╨╜╨░</h2>
              <button className={styles.closeButton} onClick={closeCart} aria-label="╨Ч╨░╨║╤А╤Л╤В╤М ╨║╨╛╤А╨╖╨╕╨╜╤Г">
            ...
            {items.length === 0 ? (
              <div className={styles.empty}>
                ...
                <Link to="/catalog/uzel-vvoda" onClick={closeCart}>
                  <Button variant="outline">╨Я╨╡╤А╨╡╨╣╤В╨╕ ╨▓ ╨║╨░╤В╨░╨╗╨╛╨│</Button>
                </Link>
              </div>
            ) : (
              <>
                  ...
                  {items.map((item) => (
                    <div key={item.product.id} className={styles.item}>
                      ...
                      <div className={styles.itemInfo}>
                        ...
                        <p className={styles.itemPrice}>{item.product.price.toLocaleString('ru-RU')} тВ╜</p>
                ...
                <div className={styles.footer}>
                  ...
                  <div className={styles.actions}>
                    ...
                    <Link to="/checkout" onClick={closeCart}>
                      <Button fullWidth>╨Ю╤Д╨╛╤А╨╝╨╕╤В╤М ╨╖╨░╨║╨░╨╖</Button>
                    </Link>
                  </div>
                </div>
              </>
