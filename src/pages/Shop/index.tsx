      ...
      <div className={styles.shop} id="catalog">
        ...
        <div className={styles.shopHero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.heroTitle}>{currentCategoryName || 'Магазин'}</h1>
            <p className={styles.heroSubtitle}>Инженерное оборудование</p>
          </div>
        </div>
        ...
        <div className={styles.container}>
          <div className={styles.shopLayout}>
            ...
            <section className={styles.mainSection} aria-label="Список товаров">
              <div className={styles.sectionTop}>
                <p className={styles.sectionLead}>Комплектующие и оборудование.</p>
              </div>
                        ...
                        <Link to={`/shop/product/${product.slug}`} className={styles.borkCardLink} aria-label={product.name}>
                          ...
                          <div className={styles.borkInfo}>
                            ...
                            <div className={styles.borkPriceRow}>
                              <span className={styles.borkPrice}>{product.price.toLocaleString('ru-RU')} ₽</span>
                              {product.old_price && (
                                <span className={styles.borkOldPrice}>{product.old_price.toLocaleString('ru-RU')} ₽</span>
                              )}
                            </div>
                          </div>
                        </Link>
